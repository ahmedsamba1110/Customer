  ...
  Widget _buildViewDetails({
    required final BuildContext context,
      ...
      CustomRoundedButton(
          ...
          showBorder: false,
          backgroundColor: context.colorScheme.accentColor.withValues(alpha: 0.1));

  Widget _buildCategoryContainer({required BuildContext context}) {
    return CustomContainer(
      color: Theme.of(context).colorScheme.lightGreyColor.withValues(alpha: 0.25),
  ...
  Widget _buildCustomStatusContainer({
    ...
    required final String status,
      ...
      CustomContainer(
        ...
        borderRadius: 5,
        color:
            UiUtils.getBookingStatusColor(statusVal: status).withValues(alpha: 0.1),
        child: CustomText(
          status == 'pending'
      ...
      child: Column(
        ...
        children: [
          ...
          CustomText(
            ...
            color:
                Theme.of(context).colorScheme.lightGreyColor.withValues(alpha: 0.5),
            fontSize: 14,
          ),
