...
class _RequestServiceFormScreenState extends State<RequestServiceFormScreen> {
  ...
  Future<void> _submitForm(BuildContext context) async {
    try {
      UiUtils.removeFocus();
      // if (minBudgetController.text.trim().isEmpty ||
      //     maxBudgetController.text.trim().isEmpty ||
      //     rawEndTime.isEmpty ||
      //     rawStartTime.isEmpty) {
      //   await UiUtils.showMessage(
      //       context,
      //       "fieldsMustNotBeEmpty".translate(context: context),
