...
class ProviderDetailsScreen extends StatefulWidget {
  const ProviderDetailsScreen({required this.providerID, final Key? key})
      : super(key: key);
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero).then((final value) {
      ...
      context
          ...
          .getPromocodes(providerId: widget.providerID);
    });
                            ...
                            children: [
                              CustomSizedBox(
                                ...
                                child: CustomCachedNetworkImage(
                                  ...
                                  width: 100,
                                  networkImageUrl:
                                      state.providerDetails.bannerImage!,
                                  fit: BoxFit.cover,
                                ),
                              ),
                                  ...
                                  child: ReviewsContainer(
                                    ...
                                    totalNumberOfRatings:
                                        state.providerDetails.numberOfRatings ??
                                            "0",
                                    averageRating:
                                        state.providerDetails.ratings ?? "0",
