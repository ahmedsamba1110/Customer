  ...
  void _navigateToOrderConfirmation({required final bool isSuccess}) {
    ...
    Navigator.pushNamed(
      ...
      arguments: {
        ...
        "isReorder": widget.isFrom == "reOrder" ? '1' : '0'
      },
    );
  }
  ...
  Widget buildAddressSelector() =>
      BlocListener<AddAddressCubit, AddAddressState>(
        listener: (final BuildContext context,
            final AddAddressState addAddressState) {
                                  ...
                                  children: <Widget>[
                                      ...
                                      List.generate(
                                        ...
                                        (index) {
                                          ...
                                          if (getAddressState.data.isNotEmpty) {
                                            addressData =
                                                addressesState.addresses[index];
                                          }
                                          return AddressSelector(
                                            ...
                                            onTap: () {
                                              ...
                                              selectedAddress = addressesState
                                                  .addresses[index];
                                              setState(() {});
                                            },
        ...
        child: Stack(
          children: [
                              ...
                              children: [
                                ListView.builder(
                                  ...
                                  itemCount: widget.isFrom == "cart"
                                      ...
                                      : widget.isFrom == "customJobRequest"
                                          ? 0
                                          : state.reOrderCartData?.cartDetails
                                              ?.length,
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: ChargesTile(
                                            ...
                                            title3: (cartDetails.serviceDetails!
                                                            .discountedPrice !=
                                                        '0'
                                                    ? cartDetails
                                                        .serviceDetails!
            ...
            Align(
                ...
                child: continueButtonContainer(context))
          ],
        ),
      ),
    );
